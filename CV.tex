...
\newarticle{diff_hymd.pdf}{Carrer M, \textbf{Cezar HM}, Bore SL, Ledum M, Cascella M}{Learning Force Field Parameters from Differentiable Particle-Field Molecular Dynamics}{ChemRxiv}{DOI}{https://doi.org/10.26434/chemrxiv-2024-js244-v3}{We develop a differentiable molecular dynamics software based on the Hamiltonian hybrid particle-field formalism, and use it to establish a protocol for automated optimization of force field parameters.}
