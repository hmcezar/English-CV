...
\hspace{35pt}
\includegraphics[width=1.4in,valign=c]{images/henrique3.jpg}
\end{minipage}
%\quad
...
\noindent\fbox{%
    ...
    % My research interests are in the development of new methods for simulation and data analysis, including developing and employing machine learning methods for solving scientific problems.}
    }
}
...
\noindent\years{2024--}\textbf{Researcher, Hylleraas Centre for Quantum Molecular Sciences, University of Oslo}\\
Working in the H2O-MOF project developing new methods and applying machine learning potentials to investigate the conductivity of ionic species through metal-organic frameworks membranes.\\
\noindent\years{2022--2024}\textbf{Postdoctoral researcher, Hylleraas Centre for Quantum Molecular Sciences, University of Oslo}\\
...
Specifically, I have experience implementing and using Monte Carlo methods and molecular dynamics for the simulation of solute-solvent, interfacial and biomolecular systems.
I also have experience using Metainference to integrate experimental and simulation data, and have given contributions to PLUMED in this regard.
On top of the molecular simulation methods, I have some experience with global optimization algorithms, clustering algorithms, fitting of interatomic potentials, and density functional theory.

Recently, my collaborators and I have been working on the development of a active learning method to train machine learning potentials for molecular simulations using less reference data.
The method is called Calibrated Adversarial Geometry Optimization (CAGO) and generates new configurations based on high uncertatinty forces.
...
\newsoftware{\textbf{Cezar HM} \textit{et al.}}{Hylleraas Software Platform}{\href{https://gitlab.com/hylleraasplatform}{https://gitlab.com/hylleraasplatform} \\ 
A platform to facilitate creating workflows and working with scientific software. My main contributions are to the development of the active learning package, and the interface for the training and evaluation of NequIP/Allegro models.}
...
\newarticle{c12eo_tx100.jpg}{\textbf{Cezar HM}, Bjørnestad VA, Prévost S, Lund R, Cascella M}{Beyond Core–Shell Micellar Structures: Complex Structures in Simple Surfactants}{\emph{Small Structures} 2400553, 2024}{DOI}{https://doi.org/10.1002/sstr.202400553}{We show how using Metainference one can go beyond fitting simple geometric models to interpret SAXS and SANS data, and how this is necessary even for relatively simple systems. We also address Triton X-100 aggregates, for which structures have been debated.}

\newarticle{multigauss_hhpf.jpeg}{Sen S, \textbf{Cezar HM}, Ledum M, Li X, Cascella M}{Phase coexistence in Hamiltonian hybrid particle–field theory using a Multi-Gaussian approach}{\emph{The Journal of Physical Chemistry B} 128:11739, 2024}{DOI}{https://doi.org/10.1021/acs.jpcb.4c05525}{This study introduces an implementation of multiple Gaussian filters within the Hamiltonian hybrid particle-field (HhPF) theory. Using a two Gaussian filter we show that HhPF effectively captures detailed information on phase coexistence and interfacial phenomena.}
...
\newarticle{cago_al.pdf}{\textbf{Cezar HM}, Bodenstein T, Sveinsson HA, Ledum M, Reine S, Bore SL}{Learning atomic forces from uncertainty-calibrated adversarial attacks}{arXiv}{DOI}{https://doi.org/10.48550/arXiv.2502.18314}{We develop Calibrated Adversarial Geometry Optimization (CAGO). The method calibrates the uncertainty estimates for the predicted forces and generates new configurations with high uncertainty which are fed to the active learning loop.}

\newarticle{beyond_pores.png}{Koynarev VR, Nader ML, Borgos KKA, \textbf{Cezar HM}, Porcar L, Narayanan T, Cascella M, Lund R}{Beyond Structural Pores: Transient Permeabilization of Lipid Membranes by Antimicrobial Peptides}{ChemRxiv}{DOI}{https://doi.org/10.26434/chemrxiv-2025-bmtmq}{Thoery and experiments are combined to reveal that even unstructured and non-penetrating antimicrobial peptides (AMPs) can rapidly permeabilize lipid membranes, with complete ion equilibration occurring in only a few tens of milliseconds.}
...
\newarticle{n2-isotherms.png}{Martins Junior CA, \textbf{Cezar HM}, Damasceno DA, Miranda CR}{Effects of van der Waals interaction on the \ce{N2} adsorption on carbon nanotubes: proposal of new force field parameters}{arXiv}{DOI}{https://doi.org/10.48550/arXiv.2307.10117}{We investigate the adsorption of \ce{N2} in CNTs, proposing an interatomic potential that correctly describe the energies for different adsorption sites, leading to a more accurate description of adsorption isotherms.}
...
\talk{Jul 2024}{Dublin, Ireland}\textbf{Metainference simulations to interpret small angle scattering experiments} \\ 9th EuChemS Chemistry Congress\\[0.05in]

\talk{Sep 2019}{S\~ao Carlos, Brazil}\textbf{DICEtools and Clustering-Traj: From simulation setup to data analysis} \\ III New Energies Innovation Center - Computational Material Science Division Workshop\\[0.05in]

\talk{Feb 2019}{S\~ao Carlos, Brazil}\textbf{Monte Carlo Methods} \\ II New Energies Innovation Center - Computational Material Science Division Workshop (Invited talk)\\[0.05in]

\talk{Sep 2018}{Bras\'ilia, Brazil}\textbf{Comparison Between Configurational Bias Monte Carlo and Molecular Dynamics Sampling for Sampling Conformational Stability with High Energy Barriers} \\ VII SeedMol  \\[0.05in]
...
\talk{Mar 2017}{Rio de Janeiro, Brazil}\textbf{How Indiana Jones is actually a bad explorer when it comes to molecules and how I can do better} \\ Finals of My Thesis in 180 seconds (Swissnex
Brazil) \\[0.05in]

\talk{Sep 2014}{Jo\~ao Pessoa, Brazil}\textbf{Parallel Tempering Monte Carlo Investigation of Phase-Changes in Nanoclusters} \\ XIII Brazilian Materials Research Society Meeting \\[0.05in]
...
\talk{May 2017}{Recife, Brazil}\textbf{III Advanced School on Biomolecular Simulation} \\ Member of the local committee.
