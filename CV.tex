...
I have 4 manuscripts in different steps of preparation, of which I highlight 2 that are under the review of the coauthors and should be submitted in the next weeks.
\\

\newarticle{ptmc_pt_alloys.png}{\textbf{Cezar HM}, Rondina GG, Da Silva JLF}{Thermodynamic properties of 55-atom Pt-based nanoalloys: phase changes and structural effect on electronic properties}{}{}{}{We investigate the effects of temperature in Pt-based nanoalloys, performing Parallel Tempering Monte Carlo simulations using many-body potentials and DFT calculations.}
