...
\noindent\fbox{%
    \parbox{\textwidth}{ 
    {A Ph.D. candidate working with computational physics/chemistry and developing scientific software. My main research interest is the efficient sampling of molecular structure and thermodynamic properties, especially using Monte Carlo methods.}
    }
}
